/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b058699bbfc1e5e4eb077b343a7adfd5)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PARTY_KEY">> {}
}
